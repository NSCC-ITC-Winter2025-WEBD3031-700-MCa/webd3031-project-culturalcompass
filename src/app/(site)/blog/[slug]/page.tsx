        ...
        <div className="container lg:max-w-screen-xl md:max-w-screen-md mx-auto lg:px-0 px-4">
          <div className="grid md:grid-cols-12 grid-cols-1 items-center">
            ...
            <div className="flex items-center md:justify-center justify-start gap-6 col-span-4 pt-4 md:pt-0">
              ...
              />
              <div className="">
                <span className="text-[22px] leading-[2rem] font-bold text-midnight_text dark:text-white">Silicaman</span>
            ...
            <div className="w-full px-4">
              ...
              <div className="-mx-4 flex flex-wrap">
                ...
                <div className="w-full px-4 lg:w-4/12">
                  <div>
                    <div className="mb-8 flex flex-col rounded-lg">
                      <div className="w-full py-12 px-11 bg-white dark:bg-darkmode shadow-lg border-b-2 border-lightborder dark:border-dark_border rounded-t-lg">

                        <h2
                          className="wow fadeInUp relative mb-5 text-2xl dark:text-white text-black  sm:text-[28px] leading-[2.25rem]"
                          data-wow-delay=".1s"
                        >
                          Share
                        </h2>
                        <div className="flex gap-4 flex-col">
                          <div className="bg-[#526fa3] hover:bg-[#526fa3]/90 py-4 px-6 text-xl rounded-lg text-white">
                          ...
                          <div className="bg-[#46C4FF] hover:bg-[#46C4FF]/90 py-4 px-6 text-xl rounded-lg text-white">
                            <Link href="#" className="flex items-center ">
                              <svg
                          ...
                          <div className="bg-[#3C86AD] hover:bg-[#3C86AD]/90 py-4 px-6 text-xl rounded-lg text-white">
                            <Link href="#" className="flex items-center ">
                              <svg
                      ...
                      <div className="w-full py-12 px-11 bg-white dark:bg-darkmode shadow-lg rounded-b-lg">
