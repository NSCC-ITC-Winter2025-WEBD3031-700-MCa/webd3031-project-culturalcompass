...
const Header: React.FC = () => {
  ...
  return (
    <header
      className={`fixed h-24 top-0 z-50 w-full  transition-all ${sticky ? "shadow-lg dark:shadow-darkmd bg-white dark:bg-darkmode" : "shadow-none bg-transparent dark:bg-transparent"}`}
    >
