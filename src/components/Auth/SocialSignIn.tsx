    ...
    <>
      <div className="flex gap-4">
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-solid  border-stroke p-3.5 text-dark duration-200 ease-in dark:border-dark_border dark:text-white dark:hover:bg-primary/10 hover:!bg-primary/10"
        >
          Sign In
          <svg
            width="23"
