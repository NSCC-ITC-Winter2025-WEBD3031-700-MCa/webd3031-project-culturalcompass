  ...
  return (
    <>
      <section className="dark:bg-darkmode">
        <div className="container lg:px-0 px-4 mx-auto lg:max-w-screen-xl md:max-w-screen-md">
            ...
            <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
              ...
              <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                ...
                <div>
                  <Link
                    href="#"
                    className="text-primary text-lg font-medium flex items-center gap-3 group hover:text-midnight_text dark:hover:text-white"
                  >
                    Leave a message
                    <svg
                      width="23"
